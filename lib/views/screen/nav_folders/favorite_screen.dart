...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  // Static favorite song data matching the image
  final List<Map<String, String>> _favoriteSongs = const [
  ...
  Widget build(BuildContext context) {
    final filteredSongs = _filterSongs(_favoriteSongs, _searchQuery);
      ...
      body: filteredSongs.isEmpty && _searchQuery.isNotEmpty
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'No favorite songs found matching "$_searchQuery"',
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildFavoriteSongItem(filteredSongs[index]);
              },
            ),
    );
  }
